...
urlpatterns = [
    ...
    path('friend-request/', users_views.CreateFriendRequestAPIView.as_view({'post': 'create'}), name='add-friend'),
    path('friend-request/<int:pk>', users_views.CreateFriendRequestAPIView.as_view({'patch': 'partial_update'}), name='add-friend'),
